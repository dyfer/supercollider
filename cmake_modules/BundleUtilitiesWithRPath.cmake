# from https://github.com/Slicer/Slicer/tree/master/CMake
...
function(fixup_bundle app libs dirs)
  ...
  if(valid)
    ...
    foreach(key ${keys})
      math(EXPR i ${i}+1)
      if(APPLE)
        get_filename_component(element_filename "${${key}_RESOLVED_EMBEDDED_ITEM}" NAME)

        if(NOT element_filename IN_LIST CFG_IGNORE_ITEM)
            message(STATUS "${i}/${n}: fixing up '${${key}_RESOLVED_EMBEDDED_ITEM}'")
            fixup_bundle_item("${${key}_RESOLVED_EMBEDDED_ITEM}" "${exepath}" "${dirs}")
        else()
            message(STATUS "${i}/${n}: skipping '${${key}_RESOLVED_EMBEDDED_ITEM}'...")
        endif()
      else()
